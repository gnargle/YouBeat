...
namespace YouBeatTypes {
    ...
    public enum GameState { Menu, Setup, Game, Pause, GameEnding, GameOver, Init, ReturnToMenu, Title, HighScoreEntry, AwaitingLaunchpad, ReturnToTitle, PreGameHold };
    ...
    public enum ControllerCreator { Console, Mapper, Youbeat };
}
